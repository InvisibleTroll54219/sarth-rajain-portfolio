...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // const { REACT_APP_SERVICEID, REACT_APP_TEMPLATE, REACT_APP_PUBLICKEY } = {'service_iuhrv8n', 'template_tqpxbwx','He1sx5Rxutscl3P_j'}
    //   process.env;
    console.log({
    ...
    emailjs
    .send('service_iuhrv8n', 'template_tqpxbwx', templateParams, {
        ...
        <div className="flex-auto w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/InvisibleTroll54219", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/invisibletroll.54219/",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/sarth-rajain-a89637228",
                    "_blank"
                  )
                }
              >
